(function () {
  ...
  $(document).ready(function () {
    ...
    // Body Background
    var body_dark = jQuery(".body-dark");
    var body_light = jQuery(".body-light");

    body_dark.click(function () {
      "use strict";
      jQuery(this).addClass("active");
      body_light.removeClass("active");
      body.removeClass("body-light").addClass("body-dark");

      //Store in local storage
      setOptions("bodyBackground", "body-dark");
    });

    //Click for current options
    if (currentOptions.bodyBackground === "body-dark") {
      body_dark.trigger("click");
    }
    ...
    body_light.click(function () {
      ...
      //Store in local storage
      setOptions("bodyBackground", "body-light");
    });

    //Click for current options
    if (currentOptions.bodyBackground === "body-light") {
      body_light.trigger("click");
    }
